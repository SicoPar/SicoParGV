...
public enum SimpleObject_persona implements PersonaWithBuilderScript<SimpleObjectBuilder>, PersonaWithFinder<Usuario> {
	...
	FOO("Luciano", "Sicolo","42402145","Luciano.sicolo@hotmail.com","29953332147"), BAR("Diego", "Parra","42422145","Diego.parra@hotmail.com","2995688796"), BAZ("Fernando", "Gimenez","12302145","Fernando.gimenez@hotmail.com","299561123"), FRODO("Pedro", "Alfonso","42402557","Pedro.alfonoso@hotmail.com","2995634112");
	...
	public SimpleObjectBuilder builder() {
		return new SimpleObjectBuilder().setName(name).setNombre(nombre).setDocumento(documento).setEmail(email).setTelefono(telefono);
